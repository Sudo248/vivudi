...
void setupServiceLocator() {
  ...
  getIt.registerLazySingleton<GlobalData>(() =>
      GlobalData(appContext: getIt.get<NavigatorService>().currentContext));

  getIt.registerLazySingleton<NetworkService>(() => NetworkService());

  getIt.registerLazySingleton<UserRepository>(
      () => UserRepository(networkService: getIt.get<NetworkService>()));

  getIt.registerLazySingleton<HotelRepository>(
      () => HotelRepository(networkService: getIt.get<NetworkService>()));
